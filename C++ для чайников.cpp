...
int main() { // С функции main начинается каждая программа в языке C++
            ...
            // Пример:
                ...
                public:
                    ...
                    // Можно сократить определения конструкторов, вызвав из одного конструктора другой:
                        Car(int height): Car(height, 20.1, 12) {} // Вызвали первый конструктор не по умолчанию
    ...
    { // Виртуальные функции
         ...
         * можно вызвать виртуальную функцию для этого объекта и выполнить версию функции производного класса. */
            ...
            // Это пригождается, когда мы используем указатель как аргумент функции, например:
        ...
        // Чисто виртуальные функции
             ...
             * иначе они, в свою очередь, будут абстрактными классами. Абстрактный класс, который содержит только абстрактные методы, называется интерфейсом. */
