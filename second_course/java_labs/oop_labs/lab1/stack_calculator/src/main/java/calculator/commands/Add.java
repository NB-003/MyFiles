...
public class Add implements Command {
    ...
    public Add(String[] args, Stack<Double> stack, Map<String, Double> defines) {
        this.stack = stack;
    ...
    public void execute() throws IllegalAccessException {
        if(stack.size() < 2) {
            LOGGER.error("Not enough elements on the stack to complete the addition");
            throw new IllegalAccessException("Not enough elements on the stack to complete the addition");
        }
